        ...
        <div class="card profile-widget">
          <div class="profile-widget-header">
            ...
            <div class="profile-widget-items">
              ...
              <div class="profile-widget-item">
                <a href="#" class="btn btn-icon icon-left btn-primary" data-toggle="tooltip" data-placement="top" title="Akan mengambil data siswa dan tagihan atur yang belum dimasukkan kedalam tagihan siswa!"><i class="fas fa-retweet"></i> Sinkronisasi Data</a>
{{--                
                <div class="profile-widget-item-label">Jumlah Data</div>
                <div class="profile-widget-item-value">{{ $jmldata }} Data</div> --}}
              </div>
                        ...
                        @foreach ($datas as $data)
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="/admin/{{ $pages }}/{{$data->id}}" class="btn btn-icon btn-success"><i class="far fa-money-bill-alt"></i></a>
                            </td>
